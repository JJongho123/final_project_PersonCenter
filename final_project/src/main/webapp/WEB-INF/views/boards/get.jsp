					...
					<div class="WriterInfo">
						...
						<div class="profile_area">
							<div class="profile_info">
								...
								<em class="nick_level"> ${cus_grade} <i data-v-d34938e2=""
									class="LevelIcon icon_level"></i></em>
									

								<c:if test="${agree=='successed' || loginid eq board.board_id}">
									<a
										href="${pageContext.request.contextPath}/message/messageView?board_num=${board.board_num}"
										class="link_talk">메세지</a>
								</c:if>
							</div>
									...
									<c:if
										...
										<div class="ProductImage sold_out">
											<div class="product_thumb">
												...
												<div class="sold_area">
													<span class="text">판매 완료</span>
												</div>
											</div>
										</div>
									</c:if>
									<c:if
										test="${status_seller ne 'friend' && status_buyer ne 'friend' && board_status ne 'friend'}">
