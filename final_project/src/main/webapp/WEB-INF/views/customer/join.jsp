...
input[type="number"]::-webkit-outer-spin-button, input[type="number"]::-webkit-inner-spin-button
	...
	<script>
		...
		function emailSend() {
			...
			$.ajax({
				method : "post",
				url : "${pageContext.request.contextPath}/customer/emailSend",
				data : {
					"email" : $("#email").val()
				},
		...
		<div id="nt_body" class="nt-body">
			<div class="nt-container my-3 my-sm-4 px-0 px-sm-4 px-xl-0">
				<div class="register m-auto f-de">
					...
					<form action="joinCustomer" method="post" name="joinForm" id="joinForm"
						...
						<ul class="list-group mb-4">
							...
							<li class="list-group-item pt-3 pt-sm-4">
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" name="cus_id" value="" id="cus_id"
											class="form-control required" minlength="3" maxlength="20" required>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="password" name="cus_pw" id="cus_pw" required
											class="form-control required" class=".pw" minlength="3"
											maxlength="20">
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="button" style="float: left;"
											class="btn btn-primary" onclick="emailSend();" value="본인인증" />
									</div>
								</div>
								

								<div class="form-group row">
									<label class="col-sm-2 col-form-label" for="reg_mb_nick">인증번호<strong
										class="sr-only">필수</strong></label>
									<div class="col-sm-4">
								...
								</div> <input type="hidden" name="cus_grade" id="cus_grade"
								value="👶씨앗회원">
